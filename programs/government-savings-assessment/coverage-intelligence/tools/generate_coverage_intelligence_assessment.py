...
def build_integration_matrix() -> None:
    rows = [
        ...
        ["Jenkins API", "HTTP/CLI", "No", "N/A", "No", "N/A", "No API URL or token in env", "N/A", "Unknown", "Exported job configs / console logs", "Partial", "KB exports in programs/universal-platform-coverage/00-input-evidence"],
        ...
        ["Local qTest/Jenkins exports", "Filesystem", "Yes", "N/A", "Yes (read-only)", "qTest PDF 744 cases; Jenkins logs", "Row-level qTest IDs not exported", "N/A", "2026-06-29 qTest snapshot", "Reuse as historical evidence", "Partial", "programs/universal-platform-coverage/00-input-evidence/v2-qtest-jenkins/"],
        ["Python coverage utilities", "Local scripts", "Yes", "N/A", "Yes", "UP rebuild; GS deliverables generator", "Read-only", "N/A", "2026-07-20", "Extend existing Python collectors", "Available", "programs/universal-platform-coverage/03-tools/; programs/government-savings-assessment/tools/"],
        ["GS coverage KB (prior assessment)", "Filesystem", "Yes", "N/A", "Yes", "Repo/pipeline inventories", "No live system query", "N/A", "2026-07-20", "Baseline for this audit", "Available", "programs/government-savings-assessment/"],
