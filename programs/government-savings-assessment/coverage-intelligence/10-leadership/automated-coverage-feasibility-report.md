...
- Related KB: `programs/government-savings-assessment/`, `programs/universal-platform-coverage/`
...
- Assessment stored in git-excluded `programs/government-savings-assessment/coverage-intelligence/`
