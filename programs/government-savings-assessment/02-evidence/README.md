# Evidence pointers (external artifacts not copied)

Screenshots and live pipeline exports remain in source locations:

| Artifact | Location |
|----------|----------|
| UP assessment input evidence | `qa-automation-kb/programs/universal-platform-coverage/00-input-evidence/` |
| V2 Jenkins screenshots (Jun 2026) | `programs/universal-platform-coverage/00-input-evidence/supplemental/jenkins/` |
