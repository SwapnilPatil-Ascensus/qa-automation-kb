...
| Claim | Evidence | As-of |
|-------|----------|-------|
| V2 qTest scoped inventory 268 / V3 TestNG 379 | `programs/universal-platform-coverage/README.md` | 2026-06 |
| Daily morning validation effort ~15–20 min | Business context | — |
| Recent IDP login UI defect (resolved) | `automation-bug-lifecycle/evidence/regression-reports/06302026/...` | 2026-06-30 |
