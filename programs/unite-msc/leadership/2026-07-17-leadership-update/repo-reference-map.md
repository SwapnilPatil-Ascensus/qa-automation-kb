...
| Contribution fixture SQL | `programs/unite-msc/api-validation/sql/bank/get-mobile-contribution-fixture-by-user.sql` |
| QC4 pipeline Jira draft | `programs/unite-msc/api-validation/JIRA-story-mobile2-qc4-pipeline-dashboard.md` |
