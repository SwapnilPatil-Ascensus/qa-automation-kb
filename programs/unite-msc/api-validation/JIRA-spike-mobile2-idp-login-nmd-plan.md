...
| KB | `programs/unite-msc/api-validation/JIRA-story-mobile2-qc4-pipeline-dashboard.md` |
...
| QC4 dashboard story | `programs/unite-msc/api-validation/JIRA-story-mobile2-qc4-pipeline-dashboard.md` |
| Endpoint registry | `programs/unite-msc/api-validation/mappings/endpoint-registry.yaml` |
