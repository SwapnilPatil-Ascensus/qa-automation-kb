...
**KB module:** `qa-automation-kb/programs/unite-msc/api-validation/`  
...
- **Knowledge base** documents API → DB mapping, endpoints, auth flow: `qa-automation-kb/programs/unite-msc/api-validation/`
...
Full endpoint registry: `programs/unite-msc/api-validation/mappings/endpoint-registry.yaml`
...
| Resource | Path / link |
|----------|-------------|
| KB README | `qa-automation-kb/programs/unite-msc/api-validation/README.md` |
