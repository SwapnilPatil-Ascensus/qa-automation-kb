...
def doc_index():
    ...
    para(doc, "Single index for Unite MSC Enrollment API automation handoff. Code lives in api-test-automation. Documents live only in qa-automation-kb.")
    ...
    kv_table(doc, [
        ...
        ("KB folder", "programs/unite-msc/enrollment-handoff-qa-893"),
    ])
...
def doc_ai():
    ...
    callout(doc, "Do not put passwords, JWT, or SSN in the prompt. Attach stripped Postman or plain payloads from msc-enrollment/postman/payloads/plain/.", AMBER_BG)
