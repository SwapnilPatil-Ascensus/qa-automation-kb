...
**Location:** this folder only — **do not** put these files in the API GitLab repo.
...
```powershell
python programs/unite-msc/enrollment-handoff-qa-893/tools/generate_enrollment_handoff_pack.py
```

Requires: `python-docx`, `matplotlib`

## Sources used (already in this KB)

- Coverage: `api-test-automation/postman/EnrollmentE2E/Enrollment-Automation-Coverage-Status.md`
- CSV: `api-test-automation/mappings/enrollment-endpoint-current-state.csv`
- Tracker: `program-hub/05-unite-enrollment-migration-tracker.md`
- Team guide: `msc-enrollment/docs/12-automation-team-guide.md`
- M1/M2 style: `api-test-automation/docs/06-coverage/signoff/Mobile-*-API-Automation-Sign-Off.docx`

## Not in this pack

Mobile 1 / Mobile 2 sign-off Word files stay where they are. Atlas, V2 UI, performance JMX. Negative/partner APIs are **exclusions**, not missing coding.
