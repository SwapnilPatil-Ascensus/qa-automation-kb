...
```powershell
# Coverage files live in programs/unite-msc/enrollment/coverage/
# Generator was removed from this KB; update the matrix/CSV here or regenerate from GitLab Postman.
```
