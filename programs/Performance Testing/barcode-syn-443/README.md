...
**Status:** Performance testing **complete — GO** (Stage 1, 2026-07-31)  
**AHA:** ACS-1696  
...
| Path | Purpose |
|------|---------|
| [jira/](./jira/) | **JIRA context** — descriptions, AC, DoD for backlog items |
| [JIRA-story-SYN-443-jenkins-regression-backlog.md](./JIRA-story-SYN-443-jenkins-regression-backlog.md) | Jenkins regression — quick link |
| [postman/](./postman/) | Postman collection + QC4 + Stage 1 environments |
| [docs/08-performance-test-results-and-handover.md](./docs/08-performance-test-results-and-handover.md) | **Results, test cases, artifacts, retest policy** |
| [artifacts/](./artifacts/) | BlazeMeter screenshots, CSV data, execution report |
