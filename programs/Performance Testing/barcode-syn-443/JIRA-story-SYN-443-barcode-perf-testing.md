...
**KB module:** `qa-automation-kb/programs/barcode-syn-443/`  
...
**KB / artifacts:** `qa-automation-kb/programs/barcode-syn-443/`
...
| Authoritative curl | **Pending from Suresh** — update `programs/barcode-syn-443/api/curl-from-suresh.md` |
...
| KB README | `qa-automation-kb/programs/barcode-syn-443/README.md` |
| Postman collection | `programs/barcode-syn-443/postman/SYN-443-Barcode-API.postman_collection.json` |
| Curl → Postman guide | `programs/barcode-syn-443/docs/01-setup-curl-to-postman.md` |
| Environment strategy | `programs/barcode-syn-443/docs/02-environment-strategy.md` |
| Load profile draft | `programs/barcode-syn-443/docs/03-load-profile.md` |
| Kickoff transcript | `programs/barcode-syn-443/Call with Dattatraya and 4 others.docx` |

## Execution steps

### Phase 1 — Postman smoke (Day 1)

1. Import collection + QC4 environment from `programs/barcode-syn-443/postman/`.
...
1. Summary doc in `programs/barcode-syn-443/` (results markdown + screenshots).
...
- [ ] KB `programs/barcode-syn-443/` updated with final collection, script path, and results link
