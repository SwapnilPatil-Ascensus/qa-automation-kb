...
![Q2 V2/V3 monthly TC adds](assets/chart_q2_monthly_adds.png)

### Chart — Cumulative nightly regression growth (context)

![V2 V3 cumulative growth](assets/chart_v2_v3_cumulative.png)
...
![Mobile MSC coverage](assets/chart_mobile_msc_coverage.png)
...
![AI productivity impact](assets/chart_ai_productivity.png)
...
**Evidence:** `programs/unite-msc/api-validation/docs/01-shared/unite-msc-performance-testing-tracker.md`; Jenkins `AGSUP_IDP_REGRESSION_SUITE` (weekdays); QA-1229.
...
| Source | Path |
|--------|------|
| Apr Demand Planning | `qa-knowledge-base/10_IMPORTS_RAW/confluence_exports/Demand Planning Reports/17. QA Automation Program – 04022026.md` |
| Mar Demand Planning | `.../16. QA Automation Program – 03042026.md` |
| UP inventory (Jun) | `programs/universal-platform-coverage/01-analysis/10-reconciliation-ledger.md` |
| Mobile MSC Jul update | `programs/unite-msc/leadership/2026-07-17-leadership-update/` |
...
2. Attach these 4 PNGs from `assets/`:
