...
2) Create initial curated skeleton content for:
   ...
   - automation-bug-lifecycle/process/DAILY_REGRESSION.md
...
Then update automation-bug-lifecycle/process/RCA_PROCESS.md if a new pattern is discovered.
...
**Use when:** A regression or test failure occurs and you need to log a bug and notify leads/dev. You have (or will put) failure artifacts in a date folder under `automation-bug-lifecycle/evidence/regression-reports/[MMDDYYYY]/`.

**Templates to follow:**  
- Failure email: `automation-bug-lifecycle/reference/confluence-bug-handling/Bug Handling/1. Handling Process When a Bug.pdf`  
- Resolution email: `automation-bug-lifecycle/reference/confluence-bug-handling/Bug Handling/1b. Automation Bug Resolution Follow-Up.pdf`  
- Bug doc structure: existing bug docs in `automation-bug-lifecycle/evidence/regression-reports/` (e.g. `02032026_UniversalEnrollment_BadSqlGrammarException.md`)
...
- Folder path where artifacts are saved, e.g. automation-bug-lifecycle/evidence/regression-reports/02032026/
...
3. Follow the structure and tone of existing bug docs in automation-bug-lifecycle/evidence/regression-reports/ (e.g. 02032026 or 02022026). Be concise; no long paragraphs.
...
Follow the process in automation-bug-lifecycle/process/FLAKINESS_PLAYBOOK.md.
Identify:
- Root cause
- Fix recommendations
