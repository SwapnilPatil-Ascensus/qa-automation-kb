...
INPUT REQUIREMENTS:
- Source folder: automation-bug-lifecycle/evidence/regression-reports/[DATE]/
- Required files:
...
5. Ensure all placeholders are replaced:
   ...
   - [Link] → Path to screenshots in automation-bug-lifecycle/evidence/regression-reports/[DATE]/
...
- All screenshots must reference correct paths in automation-bug-lifecycle/evidence/regression-reports/[DATE]/
...
1. **Prepare Input Data:**
   - Place test execution evidence in `automation-bug-lifecycle/evidence/regression-reports/[YYYY-MM-DD]/`
...
**Input:**
```
automation-bug-lifecycle/evidence/regression-reports/2026-01-26/
  test-engine.pdf
  enrollment.png
  withdrawals.png
  failures.csv
...
**Command:**
```
Generate regression documentation from automation-bug-lifecycle/evidence/regression-reports/2026-01-26/
```
