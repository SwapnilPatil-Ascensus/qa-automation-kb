...
**Template Location:** `automation-bug-lifecycle/evidence/regression-reports/[DATE]/BUG_DOCUMENTATION_TEMPLATE.md`

**Process Document:** `automation-bug-lifecycle/evidence/regression-reports/BUG_REPORTING_PROCESS.md`
...
- Location: `automation-bug-lifecycle/evidence/regression-reports/[DATE]/`
- Same folder as test evidence (screenshots, reports, test data)
- Standardized naming for easy identification

**Moved Files:**
- `BUG_DOCUMENTATION_OUTPUT.md` → `automation-bug-lifecycle/evidence/regression-reports/01262026/01262026_NextGenMultiBeneEnrollment_Exception.md`
...
**Location:** `automation-bug-lifecycle/evidence/regression-reports/[DATE]/BUG_DOCUMENTATION_TEMPLATE.md`
...
1. **Test Execution** → Evidence in `automation-bug-lifecycle/evidence/regression-reports/[DATE]/`
...
```
automation-bug-lifecycle/evidence/regression-reports/
  [MMDDYYYY]/
    test-engine.pdf
    failures.csv
...
- `automation-bug-lifecycle/evidence/regression-reports/BUG_REPORTING_PROCESS.md` - Bug reporting process
- `automation-bug-lifecycle/process/DEFECT_LIFECYCLE.md` - Defect management
