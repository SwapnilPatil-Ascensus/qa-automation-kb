...
**Source Folder:** `automation-bug-lifecycle/evidence/regression-reports/[YYYY-MM-DD]/`
...
```
automation-bug-lifecycle/evidence/regression-reports/[YYYY-MM-DD]/
```
...
2. **Evidence Storage:** Files placed in `automation-bug-lifecycle/evidence/regression-reports/2026-01-26/`
...
- `automation-bug-lifecycle/process/DAILY_REGRESSION.md` - Daily regression process
