...
- Investigate root cause (follow `automation-bug-lifecycle/process/FLAKINESS_PLAYBOOK.md`)
- Implement fix
...
- `automation-bug-lifecycle/process/FLAKINESS_PLAYBOOK.md` - Flakiness handling
