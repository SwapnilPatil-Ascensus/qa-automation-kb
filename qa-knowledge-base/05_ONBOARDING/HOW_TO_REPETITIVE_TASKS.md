...
| **Bug documentation template** | `automation-bug-lifecycle/evidence/regression-reports/[DATE]/BUG_DOCUMENTATION_TEMPLATE.md` (copy from an existing date folder if missing) |
| **Bug process (naming, folder structure)** | `automation-bug-lifecycle/evidence/regression-reports/BUG_REPORTING_PROCESS.md` |
| **Email template for “failure” (first email)** | `automation-bug-lifecycle/reference/confluence-bug-handling/Bug Handling/1. Handling Process When a Bug.pdf` |
| **Email template for “resolved” (resolution email)** | `automation-bug-lifecycle/reference/confluence-bug-handling/Bug Handling/1b. Automation Bug Resolution Follow-Up.pdf` |
...
| **JIRA ticket template (generic)** | `automation-bug-lifecycle/templates/JIRA_TICKET_TEMPLATE.md` |
...
1. Open or create the folder for **that day’s run**:  
   `automation-bug-lifecycle/evidence/regression-reports/[MMDDYYYY]/`  
   Example: `automation-bug-lifecycle/evidence/regression-reports/02032026/`
...
3. Copy that prompt, then **paste your details** where it says to paste:
   ...
   - Path to the folder where you put the artifacts (e.g. `automation-bug-lifecycle/evidence/regression-reports/02032026`)
...
**Bug (failure):**
- [ ] Evidence in `automation-bug-lifecycle/evidence/regression-reports/[MMDDYYYY]/`
