...
REM kubectl create configmap ags-performance-testing-user --namespace ags-qa --from-file TestRunUser.yml --from-file userProfile.jmx --from-file tf_member_login.jmx --from-file tf_member_logout.jmx --from-file tf_account_overview.jmx --from-file member_login.csv
timeout 10
kubectl apply -f perf-taurus-csr.yaml -n ags-qa
...
kubectl describe pod -n ags-qa perf-taurus-docker-pod-csr
kubectl logs perf-taurus-docker-pod-csr -n ags-qa