...
(async () => {
    ...
    const lhFlow = await lhApi.startFlow(page, {name: 'Universal Enrollment - Bank, Keep it Simple', config, flags});
    {
    ...
    {
        const targetPage = page;
        await targetPage.locator('kendo-popup li:nth-of-type(3)')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    {
        const targetPage = page;
        await targetPage.locator('#routing-number')
            .setTimeout(timeout)
            .fill('011000138');
    }
    {
        const targetPage = page;
        await targetPage.locator('#bank-name')
            .setTimeout(timeout)
            .fill('Bank of America');
    }
    {
        const targetPage = page;
        await targetPage.locator('#account-type')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    {
        const targetPage = page;
        await targetPage.locator('#account-number input')
            .setTimeout(timeout)
            .fill('12345612');
    }
    {
        const targetPage = page;
        await targetPage.locator('#confirm-account-number input')
            .setTimeout(timeout)
            .fill('12345612');
    }
    {
        const targetPage = page;
        await targetPage.locator('#ah-first-name')
            .setTimeout(timeout)
            .fill('Jill');
    }
    {
        const targetPage = page;
        await targetPage.locator('#ah-last-name')
            .setTimeout(timeout)
            .fill('Smith');
    }
    {
        const targetPage = page;
        await targetPage.locator('#is-domestic')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    {
        const targetPage = page;
        await targetPage.locator('#contribution-amount')
            .setTimeout(timeout)
            .fill('120');
    }
    await lhFlow.endTimespan();
    ...
    await lhFlow.startTimespan({ name: "Filling recurring details" });
    {
        const targetPage = page;
        await targetPage.locator('#dollars-50-container')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    {
        const targetPage = page;
        await targetPage.locator('#annual-increase')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    {
        const targetPage = page;
        await targetPage.locator('#month-increase')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    await lhFlow.endTimespan();
    await lhFlow.snapshot({ name: "Filled out recurring details" });

	await lhFlow.startTimespan({ name: "Submit recurring details" });
    {
        const targetPage = page;
        await targetPage.locator('#bottomNavPrimaryBtn')
            .setTimeout(timeout)
    ...
    {
        const targetPage = page;
        await targetPage.locator('#keep-it-simple')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    await lhFlow.endTimespan();
    await lhFlow.snapshot({ name: "Review keep it simple" });

	await lhFlow.startTimespan({ name: "Submit keep it simple" });
    {
        const targetPage = page;
        await targetPage.locator('#bottomNavPrimaryBtn')
            .setTimeout(timeout)
    ...
    {
        const targetPage = page;
        await targetPage.locator('#btn-finish')
            .setTimeout(timeout)
            .click({
              offset: {
                x: 1,
    ...
    await lhFlow.endTimespan();
	await page.waitForSelector('ue-post-account-creation');
