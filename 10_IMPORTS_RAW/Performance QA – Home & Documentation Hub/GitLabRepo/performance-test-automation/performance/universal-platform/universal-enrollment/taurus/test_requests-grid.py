...
from bzt.resources.selenium_extras import wait_for, add_flow_markers, waiter, get_locator
...
class TestBlazemeterUeGrid(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Remote(command_executor='http://172.25.166.42:4444/wd/hub', options=options)
        self.driver.implicitly_wait(timeout)
        add_flow_markers()
        apiritif.put_into_thread_store(timeout=timeout, func_mode=True, driver=self.driver, windows={}, scenario_name='Blazemeter-UE-Grid', data_sources=True)
    ...
    def _01_0_Navigate_to_Enrollment(self):
        with apiritif.smart_transaction('0. Navigate to Enrollment'):
            ...
            self.driver.get('https://agsup-ui-enrollment-stage1.gs.ascensus.com/enrollments/nmdirect')
            #self.driver.get('https://mdd.stage1.acs529.com/enrollments/mddirect')
    ...
    def _10_5b_Submit_Beneficiary_Details(self):
        with apiritif.smart_transaction('5b. Submit Beneficiary Details'):
			...
			var_loc_as[1]).get_attribute('innerText').strip(), "How much would you like to contribute to undefined's account to get started?")
