...
**KB path:** `automation-bug-lifecycle/evidence/regression-reports/05142026/05142026_QA_BUG_Stage1_UE_Down_Certs_HelmSecret_UpromiseNextgen.md`
...
Body: Stage 1 caused **mass UE regression failures**; IDP login still works; enrollment URL unhealthy. Example: `https://nyd.stage1.acs529.com/enrollments/newyork`. **KB:** `automation-bug-lifecycle/evidence/regression-reports/05142026/`. **JIRA:** QA-___.
