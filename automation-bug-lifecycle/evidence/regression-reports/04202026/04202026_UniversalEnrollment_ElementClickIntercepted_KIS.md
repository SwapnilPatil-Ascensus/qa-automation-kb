...
**Location:** `automation-bug-lifecycle/evidence/regression-reports/04202026/`  
...
**Folder:** `automation-bug-lifecycle/evidence/regression-reports/04202026/`
...
- **Local folder:** `automation-bug-lifecycle/evidence/regression-reports/04202026/` (includes screenshot `IAD Fun allocation issue.png` and email context on IAD portfolio/strategy dropdown updates).  
...
**Artifacts:** `automation-bug-lifecycle/evidence/regression-reports/04202026/` (incl. `IAD Fun allocation issue.png`).  
