...
**Artifacts:** `automation-bug-lifecycle/evidence/regression-reports/04202026/` — **`04202026_GitLab_nightly_job_console.txt`**, **`04202026_DailyRegression_PipelineFailureRollup.md`**, **`04202026_Legacy_Web_Login_failures.txt`**, **`04202026_Web_Reg_legacy_plan_failures.txt`**.
