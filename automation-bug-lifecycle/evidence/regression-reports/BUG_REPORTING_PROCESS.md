...
1. **Test Execution** → Evidence collected in `automation-bug-lifecycle/evidence/regression-reports/[DATE]/`
...
- `automation-bug-lifecycle/process/TRIAGE_RULES.md` - Priority/severity assignment
- `automation-bug-lifecycle/templates/JIRA_TICKET_TEMPLATE.md` - JIRA template
