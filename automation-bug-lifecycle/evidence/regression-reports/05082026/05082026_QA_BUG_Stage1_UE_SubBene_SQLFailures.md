...
**KB path:** `automation-bug-lifecycle/evidence/regression-reports/05082026/05082026_QA_BUG_Stage1_UE_SubBene_SQLFailures.md`
...
Body: Stage 1 V3 regression failed mass UE + sub-bene scenarios with SQL errors. **Job:** 14273272936. **KB:** `automation-bug-lifecycle/evidence/regression-reports/05082026/05082026_QA_BUG_Stage1_UE_SubBene_SQLFailures.md`. **JIRA:** [QA-821](https://ascensuscollegesavings.atlassian.net/browse/QA-821).
