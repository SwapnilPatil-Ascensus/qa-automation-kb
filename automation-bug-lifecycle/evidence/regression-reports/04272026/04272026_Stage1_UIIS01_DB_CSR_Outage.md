...
**Folder:** `automation-bug-lifecycle/evidence/regression-reports/04272026/`  
...
- **Local folder:** `automation-bug-lifecycle/evidence/regression-reports/04272026/`  
...
**Screenshots / evidence:** `automation-bug-lifecycle/evidence/regression-reports/04272026/` (`image.png`, `image (1).png`, `image (2).png`, `image (3).png`)
...
• **JIRA:** [QA-715](https://ascensuscollegesavings.atlassian.net/browse/QA-715)  
• **Evidence:** `automation-bug-lifecycle/evidence/regression-reports/04272026/` (PNGs)
