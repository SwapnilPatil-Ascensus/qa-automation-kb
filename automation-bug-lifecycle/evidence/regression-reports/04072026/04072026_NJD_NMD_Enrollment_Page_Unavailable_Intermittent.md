...
**Location:** `automation-bug-lifecycle/evidence/regression-reports/04072026/`  
**JIRA:** `[QA-NEED_INPUT]` · **Status:** `[Open]`  
**Prompt used:** `qa-knowledge-base/00_SYSTEM/PROMPTS.md` — **H) Bug Report: JIRA + Email + Teams**
