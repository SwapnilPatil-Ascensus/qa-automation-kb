...
**Location:** `automation-bug-lifecycle/evidence/regression-reports/03302026/`  
...
- **Local folder:** `automation-bug-lifecycle/evidence/regression-reports/03302026/` (`Test Case Info.txt`)
...
- **Artifacts folder:** `automation-bug-lifecycle/evidence/regression-reports/03302026/`
- **Environment:** Stage 1
- **Priority:** High
