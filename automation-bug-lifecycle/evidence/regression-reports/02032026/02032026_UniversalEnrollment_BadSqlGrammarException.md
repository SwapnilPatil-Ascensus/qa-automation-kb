...
**Location:** `automation-bug-lifecycle/evidence/regression-reports/02032026/`  
...
### Attachments / Links
- **Screenshot:** `automation-bug-lifecycle/evidence/regression-reports/02032026/UE Failure.png` (and UE Failure 2.png)
...
- **Screenshot:** `automation-bug-lifecycle/evidence/regression-reports/02032026/UE Failure.png` (see also UE Failure 2.png)
...
- TestNG Report: https://ascensus-gs.gitlab.io/-/products/depot/qa-automation/prime-test-automation/-/jobs/12964121259/artifacts/unite/unite-universal-enrollment/target/surefire-reports/index.html#
- Screenshot: `automation-bug-lifecycle/evidence/regression-reports/02032026/UE Failure.png`
