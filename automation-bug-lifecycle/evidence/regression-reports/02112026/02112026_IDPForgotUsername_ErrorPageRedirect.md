...
**Location:** `automation-bug-lifecycle/evidence/regression-reports/02112026/`  
...
### Attachments / Links
- **Screenshot:** `automation-bug-lifecycle/evidence/regression-reports/02112026/IDP Forgot username exception.png`
...
*Use template from `automation-bug-lifecycle/reference/confluence-bug-handling/Bug Handling/1b. Automation Bug Resolution Follow-Up.pdf`*
