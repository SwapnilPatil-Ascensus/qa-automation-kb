...
- [ ] Copy `cursor-kit/SKILL.md` → `.cursor/skills/automation-bug-lifecycle/`
- [ ] Clone GitLab Project Manager (`GitlabInfoProjUI`) — see `reference/gitlab-project-manager-setup.md`
...
- [ ] Bookmark `qa-knowledge-base/00_SYSTEM/PROMPTS.md` and `qa-knowledge-base/05_ONBOARDING/HOW_TO_REPETITIVE_TASKS.md`
