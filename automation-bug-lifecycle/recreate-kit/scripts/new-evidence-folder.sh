...
MODULE_ROOT="$(dirname "$KIT_ROOT")"
REPO_ROOT="$(dirname "$MODULE_ROOT")"
EVIDENCE_ROOT="$REPO_ROOT/10_IMPORTS_RAW/regression_reports"
...
echo ""
echo "Next: add artifacts, then run prompts from automation-bug-lifecycle/recreate-kit/prompts/"
