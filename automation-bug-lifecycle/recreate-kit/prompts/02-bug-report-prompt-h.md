...
**When:** Triage confirmed **functional defect**. Evidence folder exists under `10_IMPORTS_RAW/regression_reports/[MMDDYYYY]/`.

**Templates:** Leadership-approved email/Teams formats per Confluence Bug Handling PDFs.  
**Master reference:** `00_SYSTEM/PROMPTS.md` section H.
...
- Folder path where artifacts are saved: [FILL e.g. 10_IMPORTS_RAW/regression_reports/07242026/]
...
3. Follow structure and tone of: 10_IMPORTS_RAW/regression_reports/04202026/04202026_UniversalEnrollment_ElementClickIntercepted_KIS.md
