...
1. Triage → `recreate-kit/prompts/01-triage-regression-failure.md`
2. If defect → `recreate-kit/prompts/02-bug-report-prompt-h.md`
3. Change set → GitLab Project Manager + `prompts/03-gitlab-change-set.md`

**Do not commit secrets, tokens, or customer PII** (`00_SYSTEM/CONSTRAINTS.md`).
