...
3. Read `00_SYSTEM/ROLE.md` — repo is single source of truth
...
Copy-Item "<path-to-repo>\automation-bug-lifecycle\recreate-kit\cursor-skill\SKILL.md" "$env:USERPROFILE\.cursor\skills\automation-bug-lifecycle\SKILL.md"
```
...
| Need | Path |
|------|------|
| Master prompts | `00_SYSTEM/PROMPTS.md` |
| This kit's prompts | `automation-bug-lifecycle/recreate-kit/prompts/` |
| Bug SOP | `10_IMPORTS_RAW/regression_reports/BUG_REPORTING_PROCESS.md` |
| Evidence root | `10_IMPORTS_RAW/regression_reports/[MMDDYYYY]/` |
| Step-by-step guide | `05_ONBOARDING/HOW_TO_REPETITIVE_TASKS.md` |
| Confluence SOPs (PDF) | `10_IMPORTS_RAW/confluence_exports/Bug Handling/` |
...
Adds:
- Dated folder under `10_IMPORTS_RAW/regression_reports/`
...
`10_IMPORTS_RAW/regression_reports/04202026/04202026_UniversalEnrollment_ElementClickIntercepted_KIS.md`
...
Output: `automation-bug-lifecycle/_output/`

---

## Security reminders

Per `00_SYSTEM/CONSTRAINTS.md`:
