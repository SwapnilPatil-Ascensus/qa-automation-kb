...
Use `automation-bug-lifecycle/templates/JIRA_TICKET_TEMPLATE.md` for defect logging.
...
See `automation-bug-lifecycle/process/TRIAGE_RULES.md` for detailed triage rules.
...
- `automation-bug-lifecycle/templates/JIRA_TICKET_TEMPLATE.md` - Defect template
- `automation-bug-lifecycle/process/TRIAGE_RULES.md` - Triage rules
- `automation-bug-lifecycle/process/RCA_PROCESS.md` - Root cause analysis
