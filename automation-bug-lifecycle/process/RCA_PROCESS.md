...
- Recurring failures
- Flaky tests (see `automation-bug-lifecycle/process/FLAKINESS_PLAYBOOK.md`)
...
#### RCA Report
Use `automation-bug-lifecycle/templates/RCA_TEMPLATE.md` to document:
- Problem description
- Timeline
- Analysis findings
- Root cause
...
See `automation-bug-lifecycle/templates/RCA_TEMPLATE.md` for detailed template.
...
- `automation-bug-lifecycle/templates/RCA_TEMPLATE.md` - RCA template
- `automation-bug-lifecycle/process/FLAKINESS_PLAYBOOK.md` - Flakiness investigation
- `qa-knowledge-base/09_DECISIONS_WORKLOG/DECISIONS.md` - Document decisions
